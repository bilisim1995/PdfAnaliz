"""
Bilgi Teknolojileri ve İletişim Kurumu KAYSİS Scraper Module
Bilgi Teknolojileri ve İletişim Kurumu'nun KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_bilgi_teknolojileri_iletisim_kurumu_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/45993912") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Bilgi Teknolojileri ve İletişim Kurumu mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Bilgi Teknolojileri ve İletişim Kurumu KAYSİS URL'i)
    ...
    """
    print("🔍 Bilgi Teknolojileri ve İletişim Kurumu Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Bilgi Teknolojileri ve İletişim Kurumu)")
    print("="*80)
