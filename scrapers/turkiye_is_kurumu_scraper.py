"""
Türkiye İş Kurumu KAYSİS Scraper Module
Türkiye İş Kurumu'nun KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_turkiye_is_kurumu_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/89762117") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Türkiye İş Kurumu mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Türkiye İş Kurumu KAYSİS URL'i)
    ...
    """
    print(f"🔍 Türkiye İş Kurumu Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Türkiye İş Kurumu)")
    print("="*80)
