"""
Çalışma ve Sosyal Güvenlik Eğitim ve Araştırma Merkezi (ÇASGEM) KAYSİS Scraper Module
Çalışma ve Sosyal Güvenlik Eğitim ve Araştırma Merkezi (ÇASGEM)'nin KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_calisma_sosyal_guvenlik_egitim_arastirma_merkezi_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/21827446") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Çalışma ve Sosyal Güvenlik Eğitim ve Araştırma Merkezi (ÇASGEM) mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: ÇASGEM KAYSİS URL'i)
    ...
    """
    print("🔍 Çalışma ve Sosyal Güvenlik Eğitim ve Araştırma Merkezi (ÇASGEM) Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Çalışma ve Sosyal Güvenlik Eğitim ve Araştırma Merkezi - ÇASGEM)")
    print("="*80)
