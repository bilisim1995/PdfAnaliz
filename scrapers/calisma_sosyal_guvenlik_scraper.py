"""
Çalışma ve Sosyal Güvenlik Bakanlığı KAYSİS Scraper Module
Çalışma ve Sosyal Güvenlik Bakanlığı'nın KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_calisma_sosyal_guvenlik_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/24304011") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Çalışma ve Sosyal Güvenlik Bakanlığı mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Çalışma ve Sosyal Güvenlik Bakanlığı KAYSİS URL'i)
    ...
    """
    print(f"🔍 Çalışma ve Sosyal Güvenlik Bakanlığı Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Çalışma ve Sosyal Güvenlik Bakanlığı)")
    print("="*80)
