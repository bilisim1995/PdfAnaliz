"""
Atatürk Orman Çiftliği Müdürlüğü KAYSİS Scraper Module
Atatürk Orman Çiftliği Müdürlüğü'nün KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_ataturk_orman_ciftligi_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/48347099") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Atatürk Orman Çiftliği Müdürlüğü mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Atatürk Orman Çiftliği Müdürlüğü KAYSİS URL'i)
    ...
    """
    print(f"🔍 Atatürk Orman Çiftliği Müdürlüğü Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Atatürk Orman Çiftliği Müdürlüğü)")
    print("="*80)
