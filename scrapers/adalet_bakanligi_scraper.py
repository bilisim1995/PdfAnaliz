"""
Adalet Bakanlığı KAYSİS Scraper Module
Adalet Bakanlığı'nın KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
# ============================================================================
# Yardımcı Fonksiyonlar (SGK scraper'dan import edilebilir)
# ============================================================================
...
def scrape_adalet_bakanligi_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/24301050") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Adalet Bakanlığı mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Adalet Bakanlığı KAYSİS URL'i)
    ...
    """
    print(f"🔍 Adalet Bakanlığı Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Adalet Bakanlığı)")
    print("="*80)
