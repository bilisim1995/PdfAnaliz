"""
Çay İşletmeleri Genel Müdürlüğü KAYSİS Scraper Module
Çay İşletmeleri Genel Müdürlüğü'nün KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_cay_isletmeleri_genel_mudurlugu_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/22502455") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Çay İşletmeleri Genel Müdürlüğü mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Çay İşletmeleri Genel Müdürlüğü KAYSİS URL'i)
    ...
    """
    print("🔍 Çay İşletmeleri Genel Müdürlüğü Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Çay İşletmeleri Genel Müdürlüğü)")
    print("="*80)
