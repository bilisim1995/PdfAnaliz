"""
Adli Tıp Kurumu KAYSİS Scraper Module
Adli Tıp Kurumu'nun KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_adli_tip_kurumu_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/40968900") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Adli Tıp Kurumu mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Adli Tıp Kurumu KAYSİS URL'i)
    ...
    """
    print(f"🔍 Adli Tıp Kurumu Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Adli Tıp Kurumu)")
    print("="*80)
