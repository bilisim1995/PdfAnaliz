"""
Bankacılık Düzenleme ve Denetleme Kurumu KAYSİS Scraper Module
Bankacılık Düzenleme ve Denetleme Kurumu'nun KAYSİS sitesinden mevzuat tarama modülü
"""
import requests
...
def scrape_bankacilik_duzenleme_denetleme_mevzuat(url: str = "https://kms.kaysis.gov.tr/Home/Kurum/56605468") -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
    KAYSİS sitesinden Bankacılık Düzenleme ve Denetleme Kurumu mevzuatlarını tarar ve API ile karşılaştırır
    
    Args:
        url: Taranacak kurum URL'i (varsayılan: Bankacılık Düzenleme ve Denetleme Kurumu KAYSİS URL'i)
    ...
    """
    print(f"🔍 Bankacılık Düzenleme ve Denetleme Kurumu Mevzuat Tarama Başlatılıyor...")
    print(f"📡 Site: {url}")
...
def print_results_to_console(all_sections: List[Dict[str, Any]], stats: Dict[str, Any], uploaded_documents: Optional[List[Dict[str, Any]]] = None):
    ...
    """
    print("\n" + "="*80)
    print("📋 BULUNAN MEVZUATLAR (Bankacılık Düzenleme ve Denetleme Kurumu)")
    print("="*80)
